...
def make_loss_with_center(cfg, num_classes):    # modified by gu
    ...
    elif cfg.MODEL.METRIC_LOSS_TYPE == "triplet_cosface_center":
        triplet = TripletLoss(cfg.SOLVER.MARGIN)
        cosface = CosFaceLoss(feature_size=feat_dim, num_classes=num_classes, use_gpu=True)
        center_criterion = CenterLoss(num_classes=num_classes, feat_dim=feat_dim, use_gpu=True)  # center loss
    ...
    if cfg.MODEL.METRIC_LOSS_TYPE == "triplet_cosface_center":
        return loss_func, center_criterion, cosface
    else:
