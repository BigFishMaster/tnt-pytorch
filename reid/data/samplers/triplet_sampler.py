...
class RandomIdentitySampler(Sampler):
    ...
    def __iter__(self):
        ...
        for pid in self.pids:
            ...
            random.shuffle(idxs)
            batch_idxs = []
            # NOTE: the instance of each pid will be splitted in several lists, each with length of num_instance.
            # And the last remained (smaller than num_instance) will be ignored.
            for idx in idxs:
        ...
        while len(avai_pids) >= self.num_pids_per_batch:
            ...
            for pid in selected_pids:
                # pop the fist list-element of dict[pid]
