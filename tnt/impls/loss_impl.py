...
class LossImpl:
    def __init__(self, loss_name, gpu, **kwargs):
        if loss_name == "ClassBalancedLoss":
        ...
        elif loss_name in ["CosFaceLoss", "ArcFaceLoss", "MultipleCosFaceLoss", "CosFaceLossWithNeg"]:
            ...
            sample_type = kwargs["hc_sample_type"]
            margin = kwargs["hc_margin"]
            loss = losses.__dict__[loss_name](batch_size, each_class, beta, pos_nn, sample_type, margin)
        else:
