...
# github: https://github.com/facebookresearch/semi-supervised-ImageNet1K-models
...
model_names = [
    "resnet18_ssl", "resnet18_swsl", "resnet50_ssl", "resnet50_swsl",
    "resnext50_32x4d_ssl", "resnext50_32x4d_swsl",
    "resnext101_32x4d_ssl", "resnext101_32x4d_swsl",
    "resnext101_32x8d_ssl", "resnext101_32x8d_swsl",
...
def resnet18_ssl(progress=True, **kwargs):
    ...
    return _resnet(semi_supervised_model_urls['resnet18'], 18, pretrained, progress, **kwargs)
...
def resnet50_ssl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnet(semi_supervised_model_urls['resnet50'], 50, pretrained, progress, **kwargs)
...
def resnext50_32x4d_ssl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnext(semi_supervised_model_urls['resnext50_32x4d'], Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)
...
def resnext101_32x4d_ssl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnext(semi_supervised_model_urls['resnext101_32x4d'], Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
...
def resnext101_32x8d_ssl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnext(semi_supervised_model_urls['resnext101_32x8d'], Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
...
def resnext101_32x16d_ssl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnext(semi_supervised_model_urls['resnext101_32x16d'], Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
...
def resnet18_swsl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnet(semi_weakly_supervised_model_urls['resnet18'], 18, pretrained, progress, **kwargs)
...
def resnet50_swsl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnet(semi_weakly_supervised_model_urls['resnet50'], 50, pretrained, progress, **kwargs)
...
def resnext50_32x4d_swsl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnext(semi_weakly_supervised_model_urls['resnext50_32x4d'], Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)
...
def resnext101_32x4d_swsl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnext(semi_weakly_supervised_model_urls['resnext101_32x4d'], Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
...
def resnext101_32x8d_swsl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnext(semi_weakly_supervised_model_urls['resnext101_32x8d'], Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
...
def resnext101_32x16d_swsl(progress=True, **kwargs):
    ...
    pretrained = kwargs["pretrained"]
    del kwargs["pretrained"]
    return _resnext(semi_weakly_supervised_model_urls['resnext101_32x16d'], Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
