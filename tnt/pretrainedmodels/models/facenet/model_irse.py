...
model_names = ["IR_50", "IR_101", "IR_152", "IR_SE_50", "IR_SE_101", "IR_SE_152"]
input_space = "RGB"
input_range = [0, 1]
...
class Backbone(Module):
    def __init__(self, input_size, num_layers, num_features, mode='ir'):
        ...
        if input_size[0] == 112:
            self.output_layer = Sequential(BatchNorm2d(512),
                                           Dropout(),
                                           Flatten(),
                                           Linear(512 * 7 * 7, num_features),
                                           BatchNorm1d(num_features))
        else:
            self.output_layer = Sequential(BatchNorm2d(512),
                                           Dropout(),
                                           Flatten(),
                                           Linear(512 * 14 * 14, num_features),
                                           BatchNorm1d(num_features))
